...
User `ogura@smilebot-beta1` released the packages in the `rosruby` repository by running `/usr/bin/bloom-release rosruby --track hydro --rosdistro hydro` on `Fri, 25 Oct 2013 14:11:07 -0000`
...
User `ogura@smilebot-beta1` released the packages in the `rosruby` repository by running `/usr/bin/bloom-release rosruby --track hydro --rosdistro hydro` on `Sat, 19 Oct 2013 09:16:05 -0000`
...
User `ogura@smilebot-beta1` released the packages in the `rosruby` repository by running `/usr/bin/bloom-release rosruby --track hydro --rosdistro hydro` on `Sat, 19 Oct 2013 09:11:13 -0000`
...
User `ogura@smilebot-beta1` released the packages in the `rosruby` repository by running `/usr/bin/bloom-release rosruby --track hydro --rosdistro hydro` on `Sat, 19 Oct 2013 09:09:22 -0000`
...
User `ogura@smilebot-beta1` released the packages in the `rosruby` repository by running `/usr/bin/bloom-release rosruby --track hydro --rosdistro hydro` on `Sat, 19 Oct 2013 07:20:52 -0000`
...
User `ogura@smilebot-beta1` released the packages in the `rosruby` repository by running `/usr/bin/bloom-release rosruby --rosdistro hydro --track hydro` on `Sat, 05 Oct 2013 04:43:12 -0000`
